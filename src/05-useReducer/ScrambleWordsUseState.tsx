...
export const ScrambleWords = () => {
  ...
  const handleGuessSubmit = (e: React.FormEvent) => {
    ...
    setGuess('')
    setMaxAllowErrors(maxAllowErrors)
  ...
  const handleSkip = () => {
    ...
    setMaxSkips(maxSkips);
    const newWords = words.slice(1);
    setWords(newWords);
    setCurrentWord(newWords[0]);
    setScrambledWord(scrambleWord(newWords[0]));
    setGuess('');
    if(skipCounter >= maxSkips -1){ 
        setIsGameOver(true);
        return;
    }
  };
            ...
            <form onSubmit={handleGuessSubmit} className="mb-6">
              <div className="space-y-4">
                ...
                <Button
                  ...
                  font-semibold py-3 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200"
