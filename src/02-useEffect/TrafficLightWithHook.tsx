...
export const TrafficLightWithHook = () => {
    ...
    const { light, countdown, colors, percentage, greenLight, redLight, yellowLight } = useTrafficLight();
    ...
    return (
        ...
        <div className="flex flex-col items-center space-y-8">
            ...
            <h2 className="text-white text-3xl font thin">Countdown {countdown}</h2>
